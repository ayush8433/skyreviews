...
export default function AboutPage() {
  return (
    <div className="min-h-screen font-sans antialiased text-slate-200">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="mb-10 grid gap-6 md:grid-cols-3">
            <Card className="border border-white/10 bg-slate-900/40 backdrop-blur-md rounded-3xl overflow-hidden">
              <CardHeader>
                <CardTitle className="text-3xl font-bold text-blue-400">10k+</CardTitle>
              </CardHeader>
              <CardContent className="text-sm text-slate-300">Learners supported across training and career programs.</CardContent>
            </Card>

            <Card className="border border-white/10 bg-slate-900/40 backdrop-blur-md rounded-3xl overflow-hidden">
              <CardHeader>
                <CardTitle className="text-3xl font-bold text-blue-400">120+</CardTitle>
              </CardHeader>
              <CardContent className="text-sm text-slate-300">Hiring partners and community collaborators in the ecosystem.</CardContent>
            </Card>

            <Card className="border border-white/10 bg-slate-900/40 backdrop-blur-md rounded-3xl overflow-hidden">
              <CardHeader>
                <CardTitle className="text-3xl font-bold text-blue-400">1 Mission</CardTitle>
              </CardHeader>
              <CardContent className="text-sm text-slate-300">Create life-changing opportunities through technology careers.</CardContent>
            </Card>
          </div>
          ...
          <div className="grid items-start gap-8 lg:grid-cols-2">
            <Card className="h-full border border-white/10 bg-slate-900/40 backdrop-blur-md rounded-3xl overflow-hidden">
              <CardHeader>
                <CardTitle className="text-2xl text-white">What We Believe</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                {values.map((value) => (
                  <div key={value.title} className="rounded-xl border border-white/5 bg-slate-950/40 p-4">
                    <h3 className="font-semibold text-white">{value.title}</h3>
                    <p className="mt-1 text-sm leading-relaxed text-slate-300">{value.description}</p>
                  </div>
                ))}
              </CardContent>
            </Card>
            ...
            <Card className="h-full border border-white/10 bg-slate-900/40 backdrop-blur-md rounded-3xl overflow-hidden">
              <CardHeader>
                <CardTitle className="text-2xl text-white">How SkyStates Supports Growth</CardTitle>
              </CardHeader>
              <CardContent>
                <ol className="space-y-3">
                  {milestones.map((step) => (
                    <li key={step} className="flex items-start gap-3 rounded-xl border border-white/5 bg-slate-950/40 p-4">
      ...
      <section className="py-16 md:py-20 bg-transparent border-t border-white/10 text-white text-center relative overflow-hidden">
