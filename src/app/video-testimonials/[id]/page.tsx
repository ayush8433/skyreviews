...
export default async function VideoTestimonialPage({
  ...
  // Attempt to find the testimonial from the database
  const dbTestimonial = await prisma.videoTestimonial.findFirst({
    where: { id, isActive: true },
  });

  const staticTestimonial = videoTestimonials.find((v) => v.id === id);

  if (!dbTestimonial && !staticTestimonial) {
    notFound();
  }
  ...
  const testimonial = dbTestimonial
    ? {
        ...
        summary: dbTestimonial.summary,
        name: dbTestimonial.name,
        role: dbTestimonial.role,
        company: dbTestimonial.company,
        duration: dbTestimonial.duration,
        videoUrl: dbTestimonial.videoUrl,
        thumbnailUrl: dbTestimonial.thumbnailUrl,
      }
    : staticTestimonial!;
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 space-y-12">
              ...
              {/* Key Takeaways */}
              <div className="space-y-6 bg-blue-50/50 dark:bg-slate-900/40 border border-blue-100/50 dark:border-slate-800/50 rounded-3xl p-8">
