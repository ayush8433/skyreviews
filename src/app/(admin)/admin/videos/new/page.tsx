...
export const metadata: Metadata = {
  title: "New Video | SkyReviews Admin",
};
...
export default async function NewVideoPage({
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-black/20 backdrop-blur-xl">
        <div className="flex items-center justify-between gap-4">
          <div className="space-y-2">
            ...
            <h1 className="text-3xl font-bold text-white">Add a video testimonial</h1>
            <p className="max-w-2xl text-slate-300">Upload a new testimonial or save URLs for hosted media, then arrange it on the homepage carousel.</p>
          </div>
      ...
      <VideoForm placementManagers={placementManagers} />
    </div>
  );
}