...
export const metadata: Metadata = {
  title: "DevOps Program Student Reviews | SkyReviews",
  description: "Read verified student reviews and outcome ratings for the Sky States DevOps & Cloud Systems program.",
};

export default function DevOpsReviewsPage() {
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4">
      <div className="container mx-auto max-w-3xl bg-white rounded-2xl border border-slate-200 p-8 shadow-xs space-y-6">
        <h1 className="text-3xl font-extrabold text-slate-900 border-b border-slate-100 pb-4">
          DevOps &amp; Cloud Systems Reviews
        </h1>

        <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 shadow-xs">
          <div className="flex justify-between items-start mb-2">
            <div>
              <h3 className="font-bold text-slate-800 text-sm">Kabir R.</h3>
              <p className="text-[10px] text-blue-600 font-semibold">Batch: Jan 2025</p>
            </div>
          ...
          <p className="text-xs text-slate-650 leading-relaxed italic">&ldquo;The AWS and Kubernetes automation tasks were highly challenging. Placement advisor helped with my resume.&rdquo;</p>
        </div>
