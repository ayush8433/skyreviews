        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredAlumniData.map((alumni) => (
              <AlumniCard key={alumni.id} id={alumni.id} name={alumni.name} title={alumni.title} company={alumni.company} companyLogo={alumni.companyLogo} image={alumni.image} testimonial={alumni.testimonial} slug={alumni.slug} />
            ))}
          </div>
          <div className="text-center mt-12">
            <Button asChild variant="outline" size="lg" className="border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-semibold px-8 py-3 rounded-lg transition-all duration-300">
